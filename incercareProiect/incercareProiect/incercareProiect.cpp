...
int main(int argc, char** argv)
{
	...
	// load textures
	// -------------
	unsigned int floorTexture = CreateTexture(strExePath + "\\incercareProiect\\Walls\\floor4.jpg");
	unsigned int wallTexture = CreateTexture(strExePath + "\\incercareProiect\\Walls\\wall4.jpg");

	unsigned int giraffeTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Giraffe\\giraffe.jpg");
	unsigned int cheetahTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Cheetah\\cheetah.png");
	//unsigned int monkeyTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Monkey1\\Gorilla_Bake1_PBR StoA_Diffuse.png");
	unsigned int zebraTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Zebra\\zebraskin.jpg");

	unsigned int wolfTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Wolf1\\WOLF.png");
	unsigned int foxTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Fox2\\Mat_FoxCoat_WIP.05.png");
	unsigned int bearTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Bear1\\bear.jpg");
	unsigned int deerTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Deer3\\deer1.jpg");
	//unsigned int rabbitTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Rabbit\\rabbit.jpg");

	unsigned int savannahGroundTexture = CreateTexture(strExePath + "\\incercareProiect\\Walls\\SavannahGround\\teren.jpg");

	unsigned int grassGroundTexture = CreateTexture(strExePath + "\\incercareProiect\\Walls\\Grass1.jpg");
	unsigned int dinoTero = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Dinosaur\\terodactil.jpg");
	unsigned int dinoTrex = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Dinosaur2\\TrexColor01152015.jpeg");
	unsigned int dinoStego = CreateTexture(strExePath + "\\incercareProiect\\Animals\\DinosaurSkeleton\\triceratops_Mat_baseColor.png");
	//unsigned int dinoSpino = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Dinosaur3\\Material__36_albedo.jpg");

	//unsigned int dinoTero = CreateTexture(strExePath + "\\terodactil.jpg");
	unsigned int duckTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\duck2\\duck.jpg");
	unsigned int parrotTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Parrot\\parrot.jpg");
	unsigned int pelicanTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\Pelican\\12244_Bird_diff.jpg");
	unsigned int heronTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\bird_00\\bird_dif2.png");
	unsigned int babyDuckTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\BabyDuck\\Bird_diff.jpg");
	unsigned int secondDuckTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\SecondDuck\\12252_Bird_v1_diff.jpg");
	unsigned int redBirdTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\small_red_bird\\12212_Bird_diffuse.jpg");
	unsigned int pigeonTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\pigen\\59.png");
	unsigned int glassTexture = CreateTexture(strExePath + "\\incercareProiect\\Glass\\geam.jpg");
	unsigned int woodTexture = CreateTexture(strExePath + "\\incercareProiect\\Wood\\model2.jpg");
	unsigned int firstSnakeTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\FirstSnake\\1649403578571_1.png");
	unsigned int secondSnakeTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\ThirdSnake\\Material.001.png");
	unsigned int thirdSnakeTexture = CreateTexture(strExePath + "\\incercareProiect\\Animals\\SecondSnake\\metalnessMap1.png");



	unsigned int treeTexture = CreateTexture(strExePath + "\\incercareProiect\\Tree\\savannahTree\\bark_0021.jpg");
	leafTexture = CreateTexture(strExePath + "\\incercareProiect\\Tree\\Tree\\branch.png");

	unsigned int nestTexture = CreateTexture(strExePath + "\\\incercareProiect\Nest\\textures\\04___Default_Base_Color3.png");
	...
	std::string imagePath = strExePath + "\\incercareProiect\\Animals\\Cheetah\\cheetah.png";
...
void renderWall(const Shader& shader)
{
	...
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(67.2f, 4.9f, -44.5));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	renderParallelepipedPerpendiculuarFromDoor();
	...
	model1 = glm::mat4();
	model1 = glm::translate(model1, glm::vec3(46.8f, 9.6f, -24.0));
	model1 = glm::scale(model1, glm::vec3(5.2f));
	shader.SetMat4("model", model1);
	...
	model = glm::mat4();
	//4.9
	model = glm::translate(model, glm::vec3(26.0f, 4.9f, -44.5));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	...
	model = glm::mat4();
	//4.9
	model = glm::translate(model, glm::vec3(26.95f, 4.9f, -22.0));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	...
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(46.5f, 4.9f, -45.2));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	renderParallelepipedParalelFirstDoor();
	...
	model = glm::mat4();
	model = glm::translate(model, glm::vec3(46.5f, 4.9f, -10.2));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	renderParallelepipedParalelFirstDoor();

	model = glm::mat4();
	model = glm::translate(model, glm::vec3(56.0f, 20.1f, -44.5));
	model = glm::scale(model, glm::vec3(5.2f));
	shader.SetMat4("model", model);
	renderCeiling();
}
...
void renderGiraffe()
{
	...
	if (giraffeVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Giraffe\\giraffe.obj");

		std::string filePath = "..\\incercareProiect\\Animals\\Giraffe\\giraffe.obj";
...
void renderCheetah()
{
	...
	if (cheetahVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Cheetah\\cheetah.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderSavannahTree()
{
	...
	if (savanTreeVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Tree\\savannahTree\\Tree.obj");
...
void renderNest()
{
	...
	{
		// Load tree object file
		Loader.LoadFile("..\\incercareProiect\\Nest\\Gnezdo.obj");
...
//
//
//		Loader.LoadFile("..\\incercareProiect\\Animals\\Monkey1\\gorilla.obj");
//		objl::Mesh curMesh = Loader.LoadedMeshes[0];
//		int size = curMesh.Vertices.size();
//		objl::Vertex v;
//		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderZebra()
{
	...
	if (pantherVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Zebra\\ZEBRA.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 2.0f; // factorul de scalare
		for (int j = 0; j < curMesh.Vertices.size(); j++)
		{
			v.Position.X = (float)curMesh.Vertices[j].Position.X * scaleFactor;
			v.Position.Y = (float)curMesh.Vertices[j].Position.Y * scaleFactor;
...
void renderWolf()
{
	...
	if (wolfVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Wolf1\\WOLF.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderFox()
{
	...
	if (foxVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Fox2\\ipa7x275hkdm.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderBear()
{
	...
	if (bearVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Bear1\\grst78g1kruy.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderDeer()
{
	...
	if (wolfVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Deer3\\Deer.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		const float scaleFactor = 0.5f; // factorul de scalare
...
//
//
//		Loader.LoadFile("..\\incercareProiect\\Animals\\Rabbit\\uploads_files_991253_Rabbit.obj");
//		objl::Mesh curMesh = Loader.LoadedMeshes[0];
//		int size = curMesh.Vertices.size();
//		objl::Vertex v;
//		const float scaleFactor = 0.5f; // factorul de scalare
...
void renderDinoTero()
{
	...
	if (dinoTeroVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Dinosaur\\terodactil.obj");
...
void renderDinoTrex()
{
	...
	if (dinoTrexVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Dinosaur2\\TrexByJoel3d.obj");
...
void renderDinoStego()
{
	...
	if (dinoStegoVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\DinosaurSkeleton\\triceratops.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
//
//
//		Loader.LoadFile("..\\incercareProiect\\Animals\\Dinosaur3\\deino-low.obj");
//		objl::Mesh curMesh = Loader.LoadedMeshes[0];
//		int size = curMesh.Vertices.size();
//		objl::Vertex v;
//		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderDuck()
{
	...
	if (duckVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\duck2\\duck.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderParrot()
{
	...
	if (parrotVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Parrot\\parrot.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderPelican()
{
	...
	if (pelicanVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\Pelican\\12244_Bird_v1_L2.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderHeron()
{
	...
	if (heronVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\bird_00\\bird_00.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderBabyDuck()
{
	...
	if (babyDuckVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\BabyDuck\\12250_Bird_v1_L3.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderSecondDuck()
{
	...
	if (duckSecondVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\SecondDuck\\12252_Bird_v1_L2.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderRedBird()
{
	...
	if (redBirdVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\small_red_bird\\12212_Bird_v1_l2.obj");
		objl::Mesh curMesh = Loader.LoadedMeshes[0];
		int size = curMesh.Vertices.size();
		objl::Vertex v;
		for (int j = 0; j < curMesh.Vertices.size(); j++)
...
void renderPigeon()
{
	...
	if (pigeonVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\pigen\\pigen.obj");
...
void renderWood()
{
	...
	if (woodVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Wood\\model.obj");
...
void renderFirstSnake()
{
	...
	if (firstSnakeVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\FirstSnake\\Snake.obj");
...
void renderSecondSnake()
{
	...
	if (secondSnakeVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\ThirdSnake\\smiling_cobra.obj");
...
void renderThirdSnake()
{
	...
	if (thirdSnakeVAO == 0)
	{
		...
		Loader.LoadFile("..\\incercareProiect\\Animals\\SecondSnake\\titanoboa.obj");
